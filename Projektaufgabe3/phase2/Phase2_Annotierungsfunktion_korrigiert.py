...
def annotate_xml(elem, counter=1, ctx_counter=1,
                 rows_accel=None, rows_content=None, rows_attribute=None,
                 parent_pre=None):
    ...
    for child in list(elem):
        counter, ctx_counter = annotate_xml(
            child,
            counter,
            ctx_counter,
            rows_accel,
...
if __name__ == "__main__":
    ...
    _, _ = annotate_xml(edge_root, 1, 1, accel_rows, content_rows, attribute_rows)
