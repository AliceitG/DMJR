...
Das Extraktions-Skript \texttt{phase3\_extract\_dblp.py} schreibt alle gefundenen Datensätze
...
\begin{itemize}
  \item Anzahl Publikationen von \textit{Nikolaus Augsten}%
    ...
    \begin{itemize}
      \item ICDE:   \textbf{[TODO nach Skript-Ausführung]}
      \item VLDB:   \textbf{[TODO nach Skript-Ausführung]}
      \item SIGMOD: \textbf{[TODO nach Skript-Ausführung]}
    \end{itemize}
  \item Position (Zeilennummer von\,--\,bis) der Toy-Beispiel-Publikationen in \texttt{my\_small\_bib.xml}
    \begin{itemize}
      \item \texttt{SchmittKAMM23}: \textbf{[TODO nach Skript-Ausführung]}
      \item \texttt{HutterAK0L22}:  \textbf{[TODO nach Skript-Ausführung]}
      \item \texttt{SchalerHS23}:   \textbf{[TODO nach Skript-Ausführung]}
    \end{itemize}
  \item Dateigröße von \texttt{my\_small\_bib.xml} in kB und Zeilenanzahl:
        \textbf{[TODO nach Skript-Ausführung]}
\end{itemize}
...
Das Skript \texttt{phase3\_edge\_import.py} liest \texttt{my\_small\_bib.xml} und baut
...
\begin{itemize}
  \item Relation \texttt{node}: \textbf{[TODO nach Skript-Ausführung]}
  \item Relation \texttt{edge}: \textbf{[TODO nach Skript-Ausführung]}
\end{itemize}
